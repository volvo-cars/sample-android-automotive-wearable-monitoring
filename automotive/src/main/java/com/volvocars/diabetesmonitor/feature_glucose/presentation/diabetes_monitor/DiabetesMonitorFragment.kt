...
@AndroidEntryPoint
class DiabetesMonitorFragment : Fragment() {

    private var _binding: FragmentDiabetesMonitorBinding? = null
    private val binding get() = _binding!!

    private val viewModel: DiabetesMonitorViewModel by viewModels()
    ...
    /**
     * Update UI components in [DiabetesMonitorFragment]
     *
...
//            setViewPortOffsets(0f, 0f, 0f, 0f)
    ...
    companion object {
        val TAG = DiabetesMonitorFragment::class.simpleName
    }
}