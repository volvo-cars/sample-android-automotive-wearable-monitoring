...
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.ClearPreferenceStorage
...
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.IsUnitMmol
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetCriticalNotificationInterval
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetGlucoseAlarmEnabled
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetGlucoseFetchInterval
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetGlucoseNotificationEnabled
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetThresholdValue
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetTimeFormat
import com.volvocars.wearable_monitor.feature_glucose.domain.use_case.SetUnit
import com.volvocars.wearable_monitor.feature_glucose.presentation.OpenSourceLicensesDialogFragment
...
import com.volvocars.wearable_monitor.feature_glucose.presentation.util.unitToSvg
...
class WearableSettingsFragment : PreferenceFragment() {
    ...
    @Inject
    lateinit var setGlucoseNotificationEnabled: SetGlucoseNotificationEnabled
    ...
    override fun onCreatePreferences(
        ...
        glucoseNotificationPreference.setOnPreferenceChangeListener { _, newValue ->
            setGlucoseNotificationEnabled(newValue as Boolean)
            true
        }
