...
import com.volvocars.wearable_monitor.feature_glucose.presentation.mapper.toPresentationModels
...
class NotificationService : LifecycleService() {
    ...
    private fun GlucoseSummary.isOutOfRange(threshold: Thresholds): Boolean {
