package com.volvocars.wearablemonitor.data.storage

import android.content.SharedPreferences
import com.volvocars.wearablemonitor.core.util.Constants.DEFAULT_CRITICAL_ALARM_INTERVAL
import com.volvocars.wearablemonitor.core.util.Constants.GLUCOSE_FETCH_INTERVAL_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.Constants.KEY_ALARM_LOW
import com.volvocars.wearablemonitor.core.util.Constants.KEY_ALARM_NOTIFICATION_INTERVAL
import com.volvocars.wearablemonitor.core.util.Constants.KEY_GLUCOSE_FETCH_INTERVAL
import com.volvocars.wearablemonitor.core.util.Constants.KEY_INSTANCE
import com.volvocars.wearablemonitor.core.util.Constants.KEY_MMOL
import com.volvocars.wearablemonitor.core.util.Constants.KEY_NOTIFICATION_ENABLED
import com.volvocars.wearablemonitor.core.util.Constants.KEY_THRESHOLD_HIGH
import com.volvocars.wearablemonitor.core.util.Constants.KEY_THRESHOLD_LOW
import com.volvocars.wearablemonitor.core.util.Constants.KEY_THRESHOLD_TARGET_HIGH
import com.volvocars.wearablemonitor.core.util.Constants.KEY_THRESHOLD_TARGET_LOW
import com.volvocars.wearablemonitor.core.util.Constants.KEY_TIME_FORMAT
import com.volvocars.wearablemonitor.core.util.Constants.KEY_UNIT
import com.volvocars.wearablemonitor.core.util.Constants.KEY_USER_EXISTS
import com.volvocars.wearablemonitor.core.util.Constants.THRESHOLD_HIGH_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.Constants.THRESHOLD_LOW_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.Constants.THRESHOLD_TARGET_HIGH_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.Constants.THRESHOLD_TARGET_LOW_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.Constants.TIME_FORMAT_DEFAULT_VALUE
import com.volvocars.wearablemonitor.core.util.get
import com.volvocars.wearablemonitor.core.util.put
...
class SharedPreferenceStorage @Inject constructor(
    ...
    override fun setPreferenceFromServerStatus(serverStatus: com.volvocars.wearablemonitor.domain.model.ServerStatus) {
